...
import com.example.weranga.appointmentscheduler.dao.NotificationRepository;
...
public class NotificationServiceImpl implements NotificationService {
    ...
    private final com.example.weranga.appointmentscheduler.dao.NotificationRepository notificationRepository;
    private final UserService userService;
    private final EmailService emailService;
    private final boolean mailingEnabled;

    public NotificationServiceImpl(@Value("${mailing.enabled}") boolean mailingEnabled, com.example.weranga.appointmentscheduler.dao.NotificationRepository notificationRepository, UserService userService, EmailService emailService) {
