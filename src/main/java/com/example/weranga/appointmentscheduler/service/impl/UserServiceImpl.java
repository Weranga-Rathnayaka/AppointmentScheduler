...
import com.example.weranga.appointmentscheduler.dao.RoleRepository;
import com.example.weranga.appointmentscheduler.dao.user.UserRepository;
import com.example.weranga.appointmentscheduler.dao.user.customer.CorporateCustomerRepository;
import com.example.weranga.appointmentscheduler.dao.user.customer.CustomerRepository;
import com.example.weranga.appointmentscheduler.dao.user.customer.RetailCustomerRepository;
import com.example.weranga.appointmentscheduler.dao.user.provider.ProviderRepository;
...
import com.example.weranga.appointmentscheduler.entity.user.customer.CorporateCustomer;
import com.example.weranga.appointmentscheduler.entity.user.customer.Customer;
import com.example.weranga.appointmentscheduler.entity.user.customer.RetailCustomer;
import com.example.weranga.appointmentscheduler.entity.user.provider.Provider;
import com.example.weranga.appointmentscheduler.model.ChangePasswordForm;
